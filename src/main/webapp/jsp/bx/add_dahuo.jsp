...
<dl>
	...
	<dd>
		...
		<label class="mar_r25"><input type="radio" class="z_radio" name="oaOrder.type" value="3"  checked="checked"/>大货生产</label> 
	...
	<dd><input type="text" class="z_inp" name="oaOrder.contractAmount" id="contractAmount"  title="支持数字输入" /></dd>
	...
	<dd>
		<input type="text" name="oaOrder.wantCnt" class="z_inp" id="wantCnt" title="支持数字输入"/>
		<span>单位:件</span>
	</dd>

	<dt><span>预计交期：</span></dt>
	<dd><input type="text" class="z_inp" id="exceptFinish" name="oaOrder.exceptFinish" onFocus="WdatePicker({readOnly:true})"/></dd>

	<dt><span class="pad_t5">付款方式：</span></dt>
	<dd>
	<input type="radio" class="z_radio" name="oaOrder.payType" checked="checked" value="3:6:1"/><label class="z_sty3">3:6:1</label>
	<input type="radio" class="z_radio" name="oaOrder.payType" value="3:7"/><label class="z_sty3">3:7</label>
	<input type="radio" class="z_radio" name="oaOrder.payType" value="月结30天"/><label class="z_sty3">月结30天</label>
	<input type="radio" class="z_radio" name="oaOrder.payType" value="" id="pay_other"/><label class="z_sty4">其他</label>
	<input type="text" class="z_inp" id="payother" name="payOther" onblur="javascript:payOther1();"/>
	</dd>
	...
	<dd style="height:124px">
		...
		<br/>
		<label>包含&nbsp;&nbsp;大货通知单、大货质量控制表、大货布确认表、大货辅料确认表</label>		
	...
	<a style="margin-left:60px" href="http://oa.singbada.cn/file/oa/workflow/file/3.xls">大货生产表格汇总 下载</a>
	<br/>
	<dt><span>合同条款特殊说明：</span></dt>
	<dd><textarea class="z_textarea" id="httk"></textarea></dd>

	<dt><span>备注说明：</span></dt>
	<dd><textarea class="z_textarea" id="bzsm"></textarea></dd>
	 <input name="oaOrder.memo" id="memo" type="hidden"/>

	<dt></dt>
	<dd><input type="button" value="确定" class="mar_r z_btn1" id="bsubmit"/> 
	<input type="button" value="取消" class="z_btn2" id="cancle"/></dd>
