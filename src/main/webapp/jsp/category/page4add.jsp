...
input {
	...
	<form action="/category/add" method="post" id="categoryForm">
			...
			<table style="width: 1000px;">
				...
				<tr>
					...
					<td><input type="text"
						...
						id="paymentWait_hid" class="time_hid"></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				<tr>
			...
			<table style="width: 1000px;">
				...
				<tr>
					...
					<td><input type="text"
						...
						id="otherTime_hid" class="time_hid"></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
		...
		<div style="padding-left: 8px;">
			<input type="hidden" name="dhTimebase.id"> <input
				type="hidden" name="dhTimebaseEntries[0].stepDuration" value="0">
			<input type="hidden" name="dhTimebaseEntries[0].id"> <input
				type="hidden" name="dhTimebaseEntries[0].step" value="c_dahuo_1">
			<input type="hidden" name="dhTimebaseEntries[0].stepName"
				value="新建大货订单"> <input type="hidden"
				name="dhTimebaseEntries[0].calculateDuration" value="0">
			<table style="width: 1000px;">
				<tr>
					...
					<td width="200"><input type="text"
						...
						id="dhStep1_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[1].id"> <input type="hidden"
					...
					<td width="200"><input type="text"
						...
						id="dhStep2_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[2].id"> <input type="hidden"
					...
					<td width="200"><input type="text"
						...
						id="dhStep3_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[3].id"> <input type="hidden"
				...
				<tr>
					...
					<td><input type="text"
						...
						id="dhStep4_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[4].id"> <input type="hidden"
					...
					<td><input type="text"
						...
						id="dhStep5_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[5].id"> <input type="hidden"
					...
					<td><input type="text"
						...
						id="dhStep6_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[6].id"> <input type="hidden"
				...
				<tr>
					...
					<td><input type="text"
						...
						id="dhStep7_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[7].id"> <input type="hidden"
					...
					<td><input type="text"
						...
						id="dhStep8_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[8].id"> <input type="hidden"
					...
					<td><input type="text"
						...
						id="dhStep9_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[9].id"> <input type="hidden"
				...
				<tr>
					...
					<td><input type="text"
						...
						id="dhStep10_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[10].id"> <input type="hidden"
					...
					<td><input type="text"
						...
						id="dhStep11_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[11].id"> <input type="hidden"
					...
					<td><input type="text"
						...
						id="dhStep12_hid" class="time_hid"> <input type="hidden"
						name="dhTimebaseEntries[12].id"> <input type="hidden"
