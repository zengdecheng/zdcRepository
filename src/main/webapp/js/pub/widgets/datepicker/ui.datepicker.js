...
function Datepicker() {
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonText: '请选择日期', // Text for trigger button
...
$.extend(Datepicker.prototype, {
	...
	_generateDatepicker: function(inst) {
		...
		var clear = (this._get(inst, 'mandatory') ? '' :
			'<div class="ui-datepicker-clear" style="float: left;width: 34%;"><a onclick="jQuery.datepicker._clearDate(\'#' + inst.id + '\');"' +
			(showStatus ? this._addStatus(inst, this._get(inst, 'clearStatus') || '&#xa0;') : '') + '>' +
			this._get(inst, 'clearText') + '</a></div>');
		var controls = '<div class="ui-datepicker-control">' + (isRTL ? '' : clear) +
			'<div class="ui-datepicker-close" style="float: right;width: 34%;text-align: right;"><a onclick="jQuery.datepicker._hideDatepicker();"' +
		...
		var prev = '<div class="ui-datepicker-prev" style="float: left;width: 34%;">' + (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ? 
		...
		var next = '<div class="ui-datepicker-next" style="float: right;width: 34%;text-align:right;">' + (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
			'<a onclick="jQuery.datepicker._adjustDate(\'#' + inst.id + '\', +' + stepMonths + ', \'M\');"' +
		...
		var html = (prompt ? '<div class="' + this._promptClass + '">' + prompt + '</div>' : '') +
			...
			currentDate : today)) ? '<div class="ui-datepicker-current" style="float: left;width: 30%;text-align: center;">' +
