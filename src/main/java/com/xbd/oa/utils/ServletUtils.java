...
public final class ServletUtils {
	...
	private static final int EXPIRESSECONDS = 1000;
	...
	public static void setExpiresHeader(HttpServletResponse response, long expiresSeconds) {
		//Http 1.0 header
		response.setDateHeader("Expires", System.currentTimeMillis() + expiresSeconds * EXPIRESSECONDS);
		//Http 1.1 header
	...
	public static boolean checkIfModifiedSince(HttpServletRequest request, HttpServletResponse response,
		...
		if ((ifModifiedSince != -1) && (lastModified < ifModifiedSince + EXPIRESSECONDS)) {
	...
	public static void setFileDownloadHeader(HttpServletResponse response, String fileName) {
		try {
			//中文文件名支持
			final String encodedfileName = new String(fileName.getBytes(DEFAULT_CHARSET), "ISO8859-1");
