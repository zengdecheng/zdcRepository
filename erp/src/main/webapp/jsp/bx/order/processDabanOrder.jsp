...
<html>
<head>
<title>${systemEnvironment }处理打版|SingbadaERP</title>
</head>
<body>
	...
	<div class="order_base_info">
		...
		<div id="rate" style="position: absolute; padding: 12px; width: 11%; right: 4%; top: 32px; text-align: center; color:white;">
			...
			<div>
				<span id="curNode">当前节点：${bean.map.currentNode }</span>
			</div>
		</div>
	</div>
	...
	<div id="tabPage4" class="tab_page tabpageone">
		<iframe id="iframeTechnology" width="100%" frameborder="no" border="0"
			scrolling="no" src=""> </iframe>
	</div>
	<div id="tabPage5" class="tab_page tabpageone">
		<iframe id="iframeCosting" width="100%" frameborder="no" border="0"
			scrolling="no" src=""> </iframe>
	</div>
	<div id="tabPage6" class="tab_page tabpageone">
		<iframe id="iframeMrConfirm" width="100%" frameborder="no" border="0"
			scrolling="no" src=""> </iframe>
	</div>
	<div id="tabPage7" class="tab_page tabpageone">
		<iframe width="100%" height="1150" frameborder="no" border="0"
			src=""> </iframe>
	</div>
